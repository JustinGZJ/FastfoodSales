    ...
    public class AIP : IDisposable
    {
        ...
        private void handleReceived(string data)
        {
            try
            {
                ...
                testdata.线圈3匝间结果 = dictrionalry["SURGE3-4"].judge ? 1 : 0;
